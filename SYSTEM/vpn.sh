...
# ==================================================
# Link Hosting Kalian
SKAI0="https://raw.githubusercontent.com/kope12/GPus/refs/heads/main/SYSTEM/"
...
cd /etc/openvpn/
wget https://raw.githubusercontent.com/kope12/GPus/refs/heads/main/SYSTEM/vpn.zip
unzip vpn.zip
rm -f vpn.zip
